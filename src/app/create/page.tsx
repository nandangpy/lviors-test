...
export default function page() {
    ...
    return (
        <form onSubmit={onSubmit} className='w-[600px] h-[700px] mx-auto py-12'>
            ...
            <div className='flex flex-col justify-center h-[350px] w-[350px] mx-auto gap-2'>
                <Input placeholder='Title' id='name' type='text' value={state.name} name='name' onChange={handleChange} />
                <Input big placeholder='Contect Blog' id='description' type='text' value={state.description} name='description' onChange={handleChange} />
                <div>
                </div>
