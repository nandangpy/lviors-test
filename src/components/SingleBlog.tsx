...
export default function SingleBlog({ key, data, currentUser }: BlogProps) {
    ...
    return (
        <div className="w-[1000px] border-2 p-4">
            <div className="">
                <div className="flex gap-2 justify-between items-center">
                    <Image width={300} className="w-[250px] object-contain" height={150} src={data.imageSrc} alt="Blog Image" />

                    <div className="w-[430px] flex flex-col gap-4 leading-[1.5]">
                        <h1>{data.name}</h1>
